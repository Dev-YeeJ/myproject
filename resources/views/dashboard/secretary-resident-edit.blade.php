{{-- resources/views/dashboards/secretary-resident-edit.blade.php --}}

@extends('layouts.dashboard-layout')

@section('title', 'Edit Resident - ' . $resident->first_name . ' ' . $resident->last_name)

{{-- UPDATED: Secretary Navigation --}}
@section('nav-items')
    <li class="nav-item">
...
@section('content')
<style>
    /* (Styles are from the captain's edit view) */
    .details-container {
        max-width: 1000px;
        margin: 0 auto;
    }
...
<div class="details-container">
    ...
    <a href="{{ route('secretary.resident.show', $resident->id) }}" class="back-link">
    ...
    <form action="{{ route('secretary.resident.update', $resident->id) }}" method="POST">
        ...
        <div class="details-header">
            ...
            <div class="header-actions">
                {{-- UPDATED: Route points to secretary --}}
                <a href="{{ route('secretary.resident.show', $resident->id) }}" class="btn-header btn-secondary">
