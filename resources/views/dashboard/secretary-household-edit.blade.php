...
@section('nav-items')
    ...
    <li class="nav-item">
        {{-- This page is still the 'active' one --}}
...
@section('content')
<style>
    /* All styles are identical to captain's view */
    .form-container {
        background: white;
        border-radius: 12px;
        padding: 40px;
...
<div style="max-width: 1000px; margin: 0 auto;">
    {{-- UPDATED: Point back link to the secretary households view --}}
    ...
    <div class="form-container">
        ...
        {{-- UPDATED: Form action route updated to secretary --}}
        <form action="{{ route('secretary.household.update', $household->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-actions">
                {{-- UPDATED: Cancel button links back to secretary households view --}}
