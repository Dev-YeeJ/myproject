...
@section('nav-items')
    ...
    <li class="nav-item">
        <a href="{{ route('captain.announcements.index') }}" class="nav-link active">
...
<div class="profiling-header">
    ...
    <a href="{{ route('captain.announcements.create') }}" class="btn-create-announcement">
...
{{-- Filter Bar --}}
<form action="{{ route('captain.announcements.index') }}" method="GET" class="filter-bar">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="announcement-card h-100">
            ...
            <div class="card-actions">
                <a href="{{ route('captain.announcements.edit', $announcement->id) }}" class="btn-icon" title="Edit">
                    <i class="fas fa-edit"></i>
                </a>
                <form action="{{ route('captain.announcements.destroy', $announcement->id) }}" method="POST" onsubmit="return confirm('Delete this announcement?');" style="margin:0;">
                    @csrf @method('DELETE')
