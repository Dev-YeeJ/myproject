...
<div class="directory-header">
    ...
    <form action="{{ route('secretary.incident-blotter') }}" method="GET" class="filters-section">
        ...
        <select name="status" class="filter-select" onchange="this.form.submit()">
            ...
            <option value="For Mediation" {{ $statusFilter == 'For Mediation' ? 'selected' : '' }}>For Mediation</option>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg">
                        <div class="modal-header bg-light border-bottom-0 py-3">
                            <h5 class="modal-title fw-bold pl-2">Process Case: {{ $record->case_number }}</h5>
