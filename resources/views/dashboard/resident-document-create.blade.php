...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('resident.document.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="purpose" name="purpose" rows="3" placeholder="e.g., For job application, For school requirement, etc." required>{{ old('purpose') }}</textarea>
                    </div>
