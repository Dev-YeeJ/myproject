...
<div class="profiling-header">
    <div>
        ...
        <div class="profiling-subtitle">Compose updates for residents (Kagawad Access).</div>
    </div>
...
<form action="{{ route('kagawad.announcements.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-card">
                ...
                <p class="small text-muted mb-4">
                    If unchecked, this post will be saved as a <strong>Draft</strong>.
                </p>
            ...
            <div class="sidebar-card">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text small mt-1">
                        <i class="fas fa-info-circle"></i> Kagawad announcements are broadcast to Residents by default.
                    </div>
                </div>
