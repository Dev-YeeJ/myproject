...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body p-4">
            <form action="{{ route('secretary.announcements.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('audience') is-invalid @enderror" id="audience" name="audience" required>
                        ...
                        <option value="Barangay Officials" {{ old('audience') == 'Barangay Officials' ? 'selected' : '' }}>Barangay Officials</option>
